...
(function (a) {
  if (
    ...
    check = true;
})(navigator.userAgent || navigator.vendor || navigator.userAgent);
...
dirLight.shadow.mapSize.height = 2048; // Increase shadow map resolution
dirLight.shadow.camera.top = 50;
dirLight.shadow.camera.bottom = -50;
dirLight.shadow.camera.left = -50;
dirLight.shadow.camera.right = 50;
dirLight.shadow.camera.near = 0.5; // Adjust near plane
dirLight.shadow.camera.far = 500; // Adjust far plane
dirLight.shadow.bias = -0.0001; // Adjust shadow bias
scene.add(dirLight);
